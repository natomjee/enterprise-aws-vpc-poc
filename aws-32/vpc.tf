...
resource "aws_subnet" "bootcamp-public-subnet" {
  ...
  tags = {
    Name = "32-simple Public Subnet ${count.index}"
  }
}
...
resource "aws_route_table" "public-route-table" {
  ...
  tags = {
    Name = "32-simple Public Route Table"
  }
}
...
resource "aws_route_table" "private-route-table" {
  ...
  tags = {
    Name = "32-simple Private Route Table"
  }
}
...
resource "aws_subnet" "bootcamp-private-subnet" {
  ...
  tags = {
    Name = "32-simple Private Subnet ${count.index}"
  }
}
...
resource "aws_security_group" "all-bootcamp" {
  ...
  tags = {
    Name = "32-Bootcamp Internal Access"
...
resource "aws_security_group" "external-access" {
  ...
  tags = {
    Name = "32-Bootcamp External Access"
    owner_email = var.owner_email
    owner_name = var.owner_name
  }
}
